...
//			String append = "";
////			if(param instanceof ItemStack)
////				append = ((ItemStack) param).getDisplayName().toLowerCase().replace(' ', '_');
////			if(param instanceof Block)
////				append = (new ItemStack((Block) param)).getDisplayName().toLowerCase().replace(' ', '_');
////			if(param instanceof Item)
////				append = (new ItemStack((Item) param)).getDisplayName().toLowerCase().replace(' ', '_');
//			if(param instanceof ItemStack)
//				append = cut(((ItemStack) param).getUnlocalizedName().toLowerCase());
//			if(param instanceof Block)
//				append = cut((new ItemStack((Block) param)).getUnlocalizedName().toLowerCase());
//			if(param instanceof Item)
//				append = cut((new ItemStack((Item) param)).getUnlocalizedName().toLowerCase());
//
...
//	}
	...
	{
//		return unlocalizedName.substring(0, unlocalizedName.length()-5).substring(5);
