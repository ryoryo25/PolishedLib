...
public class ModelHandheld implements IModel {

	private final ResourceLocation parentLocation = new ResourceLocation("minecraft:item/handheld");
	private ResourceLocation layer0;
	private static final String TEX_VAR_NAME = "layer0";

	public ModelHandheld(ResourceLocation layer0) {
		this.layer0 = layer0;
	}
